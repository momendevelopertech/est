...
import { SessionWaitingListWorkspace } from "@/components/waiting-list/session-waiting-list-workspace";
...
type SessionWaitingListPageProps = {
  params: {
    sessionId: string;
  };
};

export default async function SessionWaitingListPage({
  params
}: SessionWaitingListPageProps) {
