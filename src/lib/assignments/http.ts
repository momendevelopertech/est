...
import { AssignmentsServiceError } from "./service";

export const assignmentManagementRoles = [
  "super_admin",
  "coordinator",
  "data_entry",
  "senior"
...
export async function requireAssignmentsApiRole() {
  return requireApiRole([...assignmentManagementRoles]);
}
...
export function handleAssignmentRouteError(error: unknown) {
