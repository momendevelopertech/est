...
export function ActionLink({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "motion-button inline-flex h-11 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-2xl px-4.5 text-center text-sm font-semibold leading-none tracking-normal focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        variant === "primary"
