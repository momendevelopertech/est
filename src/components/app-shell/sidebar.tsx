...
export function Sidebar({ locale, user, messages, navigation }: SidebarProps) {
  return (
    <aside className="motion-shell-reveal panel sticky top-5 hidden h-[calc(100vh-2.5rem)] shrink-0 rounded-[30px] border-transparent px-4 py-4 lg:flex lg:flex-col">
      <div>
