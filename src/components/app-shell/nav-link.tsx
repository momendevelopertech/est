  ...
  switch (href) {
    case "/dashboard":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M4 5h7v6H4V5Zm9 0h7v10h-7V5ZM4 13h7v6H4v-6Zm9 4h7v2h-7v-2Z"
            fill="currentColor"
          />
        </svg>
      );
    ...
    case "/team":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M9 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm6 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5ZM4 19a5 5 0 0 1 10 0v1H4v-1Zm11 1v-1a4 4 0 0 1 5-3.87V20h-5Z"
            fill="currentColor"
          />
        </svg>
      );
    case "/locations":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M12 22s7-6.6 7-12a7 7 0 1 0-14 0c0 5.4 7 12 7 12Zm0-8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
            fill="currentColor"
          />
        </svg>
      );
    ...
    case "/reports":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M5 3h10l4 4v14H5V3Zm9 1.5V8h3.5L14 4.5ZM8 12h8v1.5H8V12Zm0 3h8v1.5H8V15Z"
            fill="currentColor"
          />
        </svg>
      );
    case "/notifications":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M12 4.5a4.5 4.5 0 0 0-4.5 4.5v2.17c0 .98-.35 1.93-.98 2.67L5 15.5h14l-1.52-1.66a3.97 3.97 0 0 1-.98-2.67V9A4.5 4.5 0 0 0 12 4.5Zm0 15a2.25 2.25 0 0 0 2.12-1.5H9.88A2.25 2.25 0 0 0 12 19.5Z"
            fill="currentColor"
          />
        </svg>
      );
    ...
    case "/test":
      return (
        <svg viewBox="0 0 24 24" fill="none" className={iconClassName} aria-hidden="true">
          <path
            d="M7 4h10v2H7V4Zm-2 4h14v12H5V8Zm3 3v2h8v-2H8Zm0 4v2h5v-2H8Z"
            fill="currentColor"
          />
        </svg>
      );
