    ...
    <div className="space-y-6">
      <Card className="panel border-transparent px-6 py-6 sm:px-8">
        <CardHeader>
          ...
          <CardTitle className="text-3xl">{messages.attendance.title}</CardTitle>
          <CardDescription>{messages.attendance.subtitle}</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-wrap gap-2">
          ...
          >
            {messages.attendance.backToSession}
          </Link>
