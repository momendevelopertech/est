...
Use these files as the working source of truth for the project:

- `../AI_START_HERE.md`: first file for any AI or human to read before continuing work
- `examops-spec-v3.md`: full product specification and detailed requirements baseline
